            ...
            <nav className="flex-1 px-3 py-4 overflow-y-auto">
                    ...
                    {NAV_ITEMS.map((item) => {
                        ...
                        return (
                            <li key={item.href}>
                                ...
                                >
                                    <span className={`text-base leading-none ${active ? 'scale-110' : ''}`}>{item.icon}</span>
                                    {item.label}
                ...
                {user?.role === 'ADMIN' && (
                    <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                        <Link
                            href="/admin/users"
                            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium no-underline text-violet-600 dark:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-900/20 transition-all"
                        >
